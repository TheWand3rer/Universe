...
namespace VindemiatrixCollective.Universe.Model
{
    ...
    {
        public bool HasRings => !Attributes.ContainsKey("Rings");
        ...
        public static Planet Mars
        {
            get
            {
                ...
                PhysicalData physical = new(Mass.FromKilograms(0.64169e24),
                                            Length.FromKilometers(3396.19),
                                            Acceleration.FromMetersPerSecondSquared(3.71),
                                            Density.FromGramsPerCubicCentimeter(3.9335),
        ...
        /// <summary>
        ///     Creates a new planet with the physical and orbital characteristics of Venus at J2000.
        ///     It returns the planet only, it must then be parented to an attractor, like the Sun.
        /// </summary>
        public static Planet Venus
        {
            get
            {
                OrbitalData orbital = new(Length.FromAstronomicalUnits(0.7233269274796513),
                                          Ratio.FromDecimalFractions(0.006755786251885929),
                                          Angle.FromDegrees(3.857944513182229),
                                          Angle.FromDegrees(240.2975100801661),
                                          Angle.FromDegrees(236.8981836121347),
                                          Angle.FromDegrees(50.7120282395987),
                                          Duration.FromDays(224.698330074763),
                                          Duration.FromHours(2801.9759999999997),
                                          Angle.FromDegrees(177.3),
                                          Angle.FromDegrees(50.11477187404284));
                PhysicalData physical = new(Mass.FromKilograms(4.8685e+24),
                                            Length.FromKilometers(6051.893),
                                            Acceleration.FromMetersPerSecondSquared(8.87),
                                            Density.FromGramsPerCubicCentimeter(5.204),
                                            Temperature.FromKelvins(735.0));

                return new Planet(nameof(Venus), physical, orbital);
            }
        }
