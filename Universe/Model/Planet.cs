    ...
    public class Planet : CelestialBody, IEnumerable<Planet>
    {
        ...
        public static Planet Earth
        {
            get
            {
                ...
                return CreateFromPhysicalData(nameof(Earth), physical, orbital);
            }
        }
        ...
        public static Planet Luna
        {
            get
            {
                OrbitalData orbital = OrbitalData.From(Length.FromKilometers(384400.0),
                ...
                PhysicalData physical = PhysicalData.Create(Mass.FromKilograms(7.349e22),
                                                            Length.FromKilometers(1738.0),
                                                            Acceleration.FromMetersPerSecondSquared(1.62),
                                                            Density.FromGramsPerCubicCentimeter(3.3437));

                return CreateFromPhysicalData(nameof(Luna), physical, orbital);
            }
        }
        ...
        public static Planet Mars
        {
            get
            {
                ...
                return CreateFromPhysicalData(nameof(Mars), physical, orbital);
            }
        }
