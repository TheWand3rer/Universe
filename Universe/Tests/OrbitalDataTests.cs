    ...
    public class OrbitalDataTests
    {
        ...
        [TestCase(@"{
                ...
                ""SiderealRotationPeriod"": 23.9344695944
                  ...
                  358.6172562416435, 358.5688856532555, 23.4392911, 23.9344695944)]
        [TestCase(@"{
        ...
        public void DeserializeOrbitalData(
            ...
            double srp)
        {
            OrbitalData actual = dataHelper.DeserializeObjectNew<OrbitalData>(input, new OrbitalDataConverter());
            ...
            CompareOrbitalData(expected, actual, tol);
        }

        public static void CompareOrbitalData(OrbitalData expected, OrbitalData actual, double tol)
        {
            ...
            Assert.AreEqual(expected.Eccentricity.DecimalFractions, actual.Eccentricity.DecimalFractions, tol,
                            nameof(OrbitalData.Eccentricity));
            Assert.AreEqual(expected.Period.Days, actual.Period.Days, tol, nameof(OrbitalData.Period));
            Assert.AreEqual(expected.Inclination.Degrees, actual.Inclination.Degrees, tol, nameof(OrbitalData.Inclination));
            ...
            Assert.AreEqual(expected.MeanAnomaly.Degrees, actual.MeanAnomaly.Degrees, tol, nameof(OrbitalData.MeanAnomaly));
            Assert.AreEqual(expected.TrueAnomaly.Degrees, actual.TrueAnomaly.Degrees, tol, nameof(OrbitalData.TrueAnomaly));
            Assert.AreEqual(expected.AxialTilt.Degrees, actual.AxialTilt.Degrees, tol, nameof(OrbitalData.AxialTilt));
